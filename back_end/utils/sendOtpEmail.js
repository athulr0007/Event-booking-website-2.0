...
<body style="margin:0;padding:0;background-color:#020b06;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#020b06;padding:48px 16px;">
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr><td style="padding:0 48px;"><div style="height:1px;background-color:rgba(255,255,255,0.06);"></div></td></tr>
        <tr>
          <td style="padding:40px 48px 32px;">
            ...
            <h1 style="margin:0 0 12px;font-size:28px;font-weight:800;color:#ffffff;letter-spacing:-0.5px;line-height:1.2;">Your login code</h1>
        ...
        <tr>
          <td style="padding:28px 48px 40px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
              <td>
                <p style="margin:0 0 6px;font-size:12px;color:rgba(255,255,255,0.2);line-height:1.6;">This is an automated message from Crowd Event Platform.</p>
                <p style="margin:0;font-size:12px;color:rgba(255,255,255,0.15);">© ${new Date().getFullYear()} Crowd · All rights reserved</p>
              </td>
      ...
      <p style="margin:24px 0 0;font-size:12px;color:rgba(255,255,255,0.15);text-align:center;">Crowd Event Platform · Secure Login</p>
    </td></tr>
  </table>
</body>
</html>`;
